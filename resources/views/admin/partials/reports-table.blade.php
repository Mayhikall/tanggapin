                        ...
                        <div class="flex items-center">
                            @if($report->image)
                                <div class="flex-shrink-0 h-12 w-12">
                                    <img class="h-12 w-12 rounded-lg object-cover" src="{{ asset('storage/reports/' . $report->image) }}" alt="">
                                </div>
                            @else
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex items-center space-x-2">
                            ...
                            <a href="{{ route('admin.report.detail', $report) }}" 
                               class="inline-flex items-center px-3 py-1 border border-gray-300 text-xs leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                <svg class="h-3 w-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <tr>
                    <td colspan="7" class="px-6 py-12 text-center">
                        <div class="text-gray-500">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Belum ada laporan yang sesuai dengan filter yang dipilih.</p>
                        </div>
                    </td>
                </tr>
            @endforelse
